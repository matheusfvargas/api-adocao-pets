...
router.get(
  ...
  authenticateToken,
  authorizeRole('admin'),
  ProtectedPetsController.getAllPets
);
...
router.get(
  ...
  authenticateToken,
  authorizeRole('admin'),
  ProtectedPetsController.getPetByID
);
...
router.post(
  ...
  authenticateToken,
  authorizeRole('admin'),
  ProtectedPetsController.createPet
);
...
router.put(
  ...
  authenticateToken,
  authorizeRole('admin'),
  ProtectedPetsController.updatePet
);
...
router.delete(
  ...
  authenticateToken,
  authorizeRole('admin'),
  ProtectedPetsController.removePet
);
...
router.get(
  ...
  authenticateToken,
  authorizeRole('admin'),
  ProtectedUsersController.getAllUsers
);
...
router.get(
  ...
  authenticateToken,
  authorizeIDAdmin,
  ProtectedUsersController.getUserByID
);
...
router.put(
  ...
  authenticateToken,
  authorizeIDAdmin,
  ProtectedUsersController.updateUser
);
...
router.delete(
  ...
  authenticateToken,
  authorizeRole('admin'),
  ProtectedUsersController.removeUser
);
...
router.get(
  ...
  authenticateToken,
  authorizeRole('admin'),
  ProtectedAdoptionsController.getAllAdoptions
);
...
router.post(
  ...
  ProtectedAdoptionsController.createAdoption
);
